...
public class LauncherSIMUL2 
{
	...
	public LauncherSIMUL2() throws IOException, InterruptedException
	{
	...
	public static void main(String[] args) throws IOException, InterruptedException{LauncherSIMUL2 l = new LauncherSIMUL2();}
}
